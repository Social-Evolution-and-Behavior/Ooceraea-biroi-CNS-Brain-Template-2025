...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def run_registration(self):
        ...
        # loop through the registration chain
        commands = []
        for step_config in self.registration_chain:
            ...
            registration_command = "antsIntroduction.sh -d 3 -r "+template_file+" -i "+input_file+" -o "+output_prefix+" -m "+num_iterations+" -t "+step+" -n "+n4_bias_field+" -q "+quality_check+" -s "+similarity_metric+" >"+output_prefix+"out.log 2>"+output_prefix+"err.log"
            ...
            # set the input file to the output file
            input_file = output_prefix+"deformed.nii.gz"

            # set the output prefix to the next step
            output_prefix = output_prefix + "deformed_"
        ...
        self.registration_worker = RegistrationWorker(commands, flip_brain_commands, output_directory, intermediate_files)
